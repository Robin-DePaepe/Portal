...
public:
	...
	void SetCollisionGroup(CollisionGroupFlag group, ColliderComponent* pCollider);
	void SetCollisionIgnoreGroups(CollisionGroupFlag ignoreGroups, ColliderComponent* pCollider);
