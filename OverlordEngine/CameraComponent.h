...
public:
	...
	physx::PxRaycastBuffer Pick(const GameContext& gameContext, CollisionGroupFlag ignoreGroups = static_cast<CollisionGroupFlag>(0), const float maxDistance = D3D11_FLOAT32_MAX) const;
