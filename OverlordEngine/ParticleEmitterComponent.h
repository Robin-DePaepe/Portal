...
struct ParticleEmitterSettings
{
	...
	float VelocityPower;	
	//The directon  of particles along X, Y and Z, measured in the object's orientation
	...
	//the amount of particles that will spawn at the start
	 int startParticleBurst;
};
...
public:
	...
	void SetStartParticleBurst(int startParticleBurst) { m_Settings.startParticleBurst = startParticleBurst; }
	...
	void SetVelocity(float velocity) { m_Settings.VelocityPower = velocity; }
	void SetDirection(DirectX::XMFLOAT3 velocity) { m_Settings.Direction = velocity; }
	...
	void SetRandomDirections(bool value) { m_Settings.randomDirections = value; }
